...
- 🌱 Estou aprendendo continuamente sobre **novas tendências em Cloud (foco em AWS), DevOps e arquitetura de software** para aprimorar as soluções que desenvolvo e arquiteto.  
- 👯 Busco colaborar em projetos de **Cloud Computing, Serverless e DevOps Tools**.  
- 💬 Pergunte-me sobre **Cloud Native, AWS, Arquitetura de Software, Platform Engineering e práticas DevOps**.  
